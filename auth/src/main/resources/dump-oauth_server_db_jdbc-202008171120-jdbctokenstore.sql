...
--
-- Host: localhost    Database: oauth_server_db_jdbc
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `oauth_server_db_jdbc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `oauth_server_db_jdbc`;
...
INSERT INTO `users_user_authorities` VALUES (2,1,1);
/*!40000 ALTER TABLE `users_user_authorities` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'oauth_server_db_jdbc'
--
...
-- Dump completed on 2020-08-17 11:20:51
