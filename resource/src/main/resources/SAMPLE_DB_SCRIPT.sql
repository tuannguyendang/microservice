...
--
-- Host: localhost    Database: resource_server_db
-- ------------------------------------------------------
...
INSERT INTO `authority` VALUES (1,'MANAGER'),(2,'USER'),(3,'CLIENT'),(4,'ADMIN');
...
INSERT INTO `matcher` VALUES (1,'/user/profile','GET',2),(2,'/user/profile','POST',2);
/*!40000 ALTER TABLE `matcher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'resource_server_db'
--
...
-- Dump completed on 2020-09-28 12:17:05
